...
- [| Có thể sắp xếp các phần tử của kiểu Comparable bởi phương thức Collections.sort(List). | Có thể sắp xếp các phần tử của kiểu Comparator bởi phương thức Collections.sort(List, Comparator). |](#-có-thể-sắp-xếp-các-phần-tử-của-kiểu-comparable-bởi-phương-thức-collectionssortlist--có-thể-sắp-xếp-các-phần-tử-của-kiểu-comparator-bởi-phương-thức-collectionssortlist-comparator-)
...
=======
- **
>>>>>>> cc8e9ac9dd67d1f207d287eaebcb1e6dc77913cc
